local keys = {
    ...
    "265844-437168-385273-909355",
    "923931-365408-248214-592121",
    "489231-829814-536444-853706",
    "810524-242322-676276-311065",
    "443184-857778-087041-765525",
    "560471-278421-541293-291102",
    "718332-585927-757442-617933",
    "113615-258965-189736-899474",
    "605925-767280-150736-252420"
}
...
for i, v in ipairs(keys) do
    if v == _G.accesskey then
        validAccessKey = true
        break
    end
end

local validUserID = false
...
if not validAccessKey then
    game.Players.LocalPlayer:Kick("Cannot execute. Invalid key!")
    wait(1.5)
    game:Shutdown()
elseif not validUserID then
    game.Players.LocalPlayer:Kick("Cannot execute. Invalid id!")
    wait(1.5)
    game:Shutdown()
else
    ...
    Title.Text = "Krahub - Murder mastery"
    ...
    function SCRIPT_TXVI67_FAKESCRIPT() -- OpenClose.OpenClose
        ...
        script.Parent.MouseButton1Click:Connect(
            function()
                ...
                if toggle then
                    script.Parent.Parent.Parent.Parent.Holder:TweenPosition(
                        UDim2.new(1, -350, 1, 0),
                        "Out",
                        "Quart",
                        0.5
                    ...
                    if script.Parent.Parent.Parent.PlayerList.Top.OpenClose.Rotation == 0 then
                        playerListOpen = true
                        script.Parent.Parent.Parent.PlayerList:TweenPosition(
                            UDim2.new(0, -25, 0, 0),
                            "Out",
                            "Quart",
                            0.5
